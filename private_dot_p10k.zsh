...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='${$((VCS_STATUS_HAS_STAGED||VCS_STATUS_HAS_UNSTAGED||VCS_STATUS_HAS_UNTRACKED||VCS_STATUS_HAS_CONFLICTED))+${VCS_STATUS_LOCAL_BRANCH} *}${$((!(VCS_STATUS_HAS_STAGED||VCS_STATUS_HAS_UNSTAGED||VCS_STATUS_HAS_UNTRACKED||VCS_STATUS_HAS_CONFLICTED)))+${VCS_STATUS_LOCAL_BRANCH}}'
